...
public class Hhelper {
	public static String aktdate="";
	public static int aktyear= 0;
	public static int aktmonth = 0;
	public static int aktday = 0;
...
//				cat = (Category) comboBox.getItemAt(i);
//				if (cat.getCid() == value) {
...
//			tabla.setSelectionBackground(vvzold);		
	...
	public void iconhere(JFrame that) {
		ImageIcon ImageIcon = new ImageIcon(ClassLoader.getSystemResource("Images/todo32.png"));
